...
/**
 * Your work, in sync – Farm team communication UI
...
const YourWorkInSync: React.FC<YourWorkInSyncProps> = ({
  ...
  const imgFrame2147223205 = "/professional-female-farmer-in-her-40s-wearing-a-pl.jpg"
  const imgFrame2147223206 = "/middle-aged-male-farmer-wearing-a-baseball-cap-and.jpg"
  const imgFrame2147223207 = "/young-asian-female-agricultural-engineer-wearing-s.jpg"
  const imgArrowUp =
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Farm team chat conversation showing collaboration sync"
    >
