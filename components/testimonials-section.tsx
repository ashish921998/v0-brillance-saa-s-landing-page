...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "FarmSight increased our corn yield by 23% in the first season. The AI predictions helped us optimize irrigation and catch pest issues before they became problems.",
      name: "Sarah Martinez",
    ...
    {
      quote:
        "Our farm efficiency improved dramatically with FarmSight's equipment integration. Task scheduling and field management became completely automated and precise.",
      name: "Emily Chen",
