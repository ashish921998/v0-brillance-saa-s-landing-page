              ...
              <div className="flex justify-center items-center">
                ...
                <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 flex justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                  <button
                    ...
                    className="flex justify-start items-center hover:text-[#37322F] transition-colors duration-200 cursor-pointer"
                  >
                    <div className="flex flex-col justify-center text-[rgba(49,45,43,0.80)] hover:text-[#37322F] text-xs md:text-[13px] font-medium leading-[14px] font-sans transition-colors duration-200">
                      Features
                    </div>
                  </button>
                  <button
